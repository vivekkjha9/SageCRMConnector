...
namespace Sage.crmErp.x2008.Feeds
{
	...
	[XmlType("salesReturnDelivery", Namespace="http://schemas.sage.com/crmErp/2008")]
		[SMEResource(CanGet=true, PluralName="salesReturnDeliveries")]
	public class salesReturnDeliveryFeedEntrySchema : Sage.Common.Syndication.FeedEntry
	{
		#region Constants
		...
		#region Documentation
		/// <summary>
		/// Initialises a new instance of the <see cref="salesReturnDeliveryFeedEntrySchema"/> class.
		/// </summary>
		#endregion
		public salesReturnDeliveryFeedEntrySchema()
		{
		}
		...
		[SMEStringProperty(Label="SalesReturnDelivery Application ID", Name="id", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string", IsUniqueKey=true)]			
		public virtual new System.String id { get { return _id; } set { SetProperty(Propertyid, ref _id, value); } }

		[SMEBoolProperty(Label="SalesReturnDelivery Active Flag", Name="active", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual System.Boolean active { get { return _active; } set { SetProperty(Propertyactive, ref _active, value); } }

		[SMEBoolProperty(Label="SalesReturnDelivery Deleted", Name="deleted", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual System.Boolean deleted { get { return _deleted; } set { SetProperty(Propertydeleted, ref _deleted, value); } }

		[SMEStringProperty(Label="SalesReturnDelivery Label", Name="label", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		public virtual System.String label { get { return _label; } set { SetProperty(Propertylabel, ref _label, value); } }

		[SMEResource(CanGet=true, CanPost=true, CanPut=true, PluralName="salesOrders", Label="SalesReturnDelivery Sales Order")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Association, IsCollection=true, Label="SalesReturnDelivery Sales Order", Name="salesOrder", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual salesOrderFeed salesOrder { get { return _salesOrder; } set { SetProperty(PropertysalesOrder, ref _salesOrder, value); } }

		[SMEStringProperty(Label="SalesReturnDelivery reference", Name="reference", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string", IsUniqueKey=true)]			
		public virtual System.String reference { get { return _reference; } set { SetProperty(Propertyreference, ref _reference, value); } }

		[SMEStringProperty(Label="SalesReturnDelivery Reference2", Nillable=true, Name="reference2", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		public virtual System.String reference2 { get { return _reference2; } set { SetProperty(Propertyreference2, ref _reference2, value); } }

		[SMEResource(CanGet=true, CanPost=true, CanPut=true, CanDelete=true, PluralName="companies")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery OperatingCompany", Name="operatingCompany", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEEnumProperty(EnumTypeName="salesReturnDeliveryStatus--enum", Label="SalesReturnDelivery Status", Nillable=true, Name="status", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual string status { get { return _status; } set { SetProperty(Propertystatus, ref _status, value); } }

		[SMEResource(CanGet=true, CanPost=true, CanPut=true, CanDelete=true, PluralName="companies")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Company", Name="company", Namespace="http://schemas.sage.com/crmErp/2008")]
		[XmlElement("company")]			
		...
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Customer", Name="customer", Namespace="http://schemas.sage.com/crmErp/2008")]
		[XmlElement("customer")]			
		...
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Customer TradingAccount", Name="tradingAccount", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEStringProperty(Label="SalesReturnDelivery Customer reference", Nillable=true, Name="customerReference", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEResource(CanGet=true, PluralName="priceLists", Label="SalesReturnDelivery PriceList")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery PriceList", Name="pricelist", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEResource(CanGet=true, CanPost=true, CanPut=true, CanDelete=true, PluralName="tradingAccounts")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Supplier TradingAccount", Name="supplierTradingAccount", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEStringProperty(Label="SalesReturnDelivery Supplier reference", Nillable=true, Name="supplierReference", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Type", Nillable=true, Name="type", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery PostalAddress", Name="postalAddress", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEStringProperty(Label="SalesReturnDelivery Method", Nillable=true, Name="deliveryMethod", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEResource(CanGet=true, CanPost=true, CanPut=true, CanDelete=true, PluralName="companies")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Carrier Company", Name="carrierCompany", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Carrier Supplier", Name="carrierSupplier", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEResource(CanGet=true, CanPost=true, CanPut=true, CanDelete=true, PluralName="tradingAccounts")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Carrier TradingAccount", Name="carrierTradingAccount", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEResource(CanGet=true, PluralName="taxCodes", Label="SalesReturnDelivery Carrier Tax Code")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Association, IsCollection=true, Label="SalesReturnDelivery Carrier Tax Code", Name="carrierTaxCodes", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Carrier reference", Nillable=true, Name="carrierReference", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Carrier Net Price", Nillable=true, Name="carrierNetPrice", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Carrier Tax Price", Nillable=true, Name="carrierTaxPrice", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Carrier Gross Price", Nillable=true, Name="carrierTotalPrice", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEResource(CanGet=true, CanPost=true, CanPut=true, PluralName="salesInvoices", Label="SalesReturnDelivery Carrier SalesInvoice")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Carrier SalesInvoice", Name="carrierSalesInvoice", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEResource(CanGet=true, CanPost=true, PluralName="purchaseInvoices", Label="SalesReturnDelivery Carrier PurchaseInvoice")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Carrier PurchaseInvoice", Name="carrierPurchaseInvoice", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEStringProperty(Label="SalesReturnDelivery Currency", Nillable=true, Name="currency", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		public virtual System.String currency { get { return _currency; } set { SetProperty(Propertycurrency, ref _currency, value); } }

		[SMEStringProperty(Label="SalesReturnDelivery OperatingCompany Currency", Name="operatingCompanyCurrency", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery OperatingCompany Currency Exchange Rate", Nillable=true, Name="operatingCompanyCurrencyExchangeRate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEEnumProperty(EnumTypeName="RateOperator--enum", Label="SalesReturnDelivery OperatingCompany Currency Exchange Rate Operator", Nillable=true, Name="operatingCompanyCurrencyExchangeRateOperator", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDateProperty(Label="SalesReturnDelivery OperatingCompany Currency Exchange Rate Date", Nillable=true, Name="operatingCompanyCurrencyExchangeRateDate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Invoice Currency", Nillable=true, Name="invoiceCurrency", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Invoice Currency Exchange Rate", Nillable=true, Name="invoiceCurrencyExchangeRate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEEnumProperty(EnumTypeName="RateOperator--enum", Label="SalesReturnDelivery Invoice Currency Exchange Rate Operator", Nillable=true, Name="invoiceCurrencyExchangeRateOperator", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDateProperty(Label="SalesReturnDelivery Invoice Currency Exchange Rate Date", Nillable=true, Name="invoiceCurrencyExchangeRateDate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Customer TradingAccount Currency", Nillable=true, Name="customerTradingAccountCurrency", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Customer TradingAccount Currency Exchange Rate", Nillable=true, Name="customerTradingAccountCurrencyExchangeRate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEEnumProperty(EnumTypeName="RateOperator--enum", Label="SalesReturnDelivery Customer TradingAccount Currency Exchange Rate Operator", Nillable=true, Name="customerTradingAccountCurrencyExchangeRateOperator", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDateProperty(Label="SalesReturnDelivery Customer TradingAccount Currency Exchange Rate Date", Nillable=true, Name="customerTradingAccountCurrencyExchangeRateDate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDateProperty(Label="SalesReturnDelivery Requested Delivery Date", Nillable=true, Name="requestedDeliveryDate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDateProperty(Label="SalesReturnDelivery Actual Delivery Date", Name="actualDeliveryDate", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMETimeProperty(Label="SalesReturnDelivery Actual Delivery Time", Nillable=true, Name="actualDeliveryTime", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Date Exception Reason", Nillable=true, Name="dateExceptionReason", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEResource(CanGet=true, PluralName="taxCodes", Label="SalesReturnDelivery Tax Code")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Association, IsCollection=true, Label="SalesReturnDelivery Tax Code", Name="taxcodes", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual taxCodeFeed taxcodes { get { return _taxcodes; } set { SetProperty(Propertytaxcodes, ref _taxcodes, value); } }

		[SMEResource(CanGet=true, CanPost=true, CanPut=true, CanDelete=true, PluralName="contacts", Label="SalesReturnDelivery Return Contact")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Return Contact", Name="deliveryContact", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEResource(CanGet=true, PluralName="salesReturnDeliveryLines", Label="SalesReturnDelivery SalesReturnDeliveryLine")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Child, IsCollection=true, Label="SalesReturnDelivery SalesReturnDeliveryLine", Name="salesReturnDeliveryLines", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Line Count", Name="lineCount", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual System.Decimal lineCount { get { return _lineCount; } set { SetProperty(PropertylineCount, ref _lineCount, value); } }

		[SMEDecimalProperty(Label="SalesReturnDelivery Requested Quantity", Nillable=true, Name="requestedQuantity", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Delivered Quantity", Name="deliveredQuantity", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEEnumProperty(EnumTypeName="discountType--enum", Label="SalesReturnDelivery Delviery Discount Type", Nillable=true, Name="deliveryDiscountType", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Delivery Discount Amount", Nillable=true, Name="deliveryDiscountAmount", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Delivery Discount Percent", Nillable=true, Name="deliveryDiscountPercent", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEEnumProperty(EnumTypeName="discountType--enum", Label="SalesReturnDelivery Delivery Additional Discount1 Type", Nillable=true, Name="deliveryAdditionalDiscount1Type", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Delivery Additional Discount1 Amount", Nillable=true, Name="deliveryAdditionalDiscount1Amount", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Delivery Additional Discount1 Percent", Nillable=true, Name="deliveryAdditionalDiscount1Percent", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEEnumProperty(EnumTypeName="discountType--enum", Label="SalesReturnDelivery Delivery Additional Discount2 Type", Nillable=true, Name="deliveryAdditionalDiscount2", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Delivery Additional Discount2 Amount", Nillable=true, Name="deliveryAdditionalDiscount2Amount", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Delivery Additional Discount2 Percent", Nillable=true, Name="deliveryAdditionalDiscount2Percent", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Text1", Nillable=true, Name="text1", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		public virtual System.String text1 { get { return _text1; } set { SetProperty(Propertytext1, ref _text1, value); } }

		[SMEStringProperty(Label="SalesReturnDelivery Text2", Nillable=true, Name="text2", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		public virtual System.String text2 { get { return _text2; } set { SetProperty(Propertytext2, ref _text2, value); } }

		[SMEDecimalProperty(Label="SalesReturnDelivery Net Total", Name="netTotal", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual System.Decimal netTotal { get { return _netTotal; } set { SetProperty(PropertynetTotal, ref _netTotal, value); } }

		[SMEDecimalProperty(Label="SalesReturnDelivery Discount Total", Name="discountTotal", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Charges Total", Nillable=true, Name="chargesTotal", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Tax Total", Name="taxTotal", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual System.Decimal taxTotal { get { return _taxTotal; } set { SetProperty(PropertytaxTotal, ref _taxTotal, value); } }

		[SMEDecimalProperty(Label="SalesReturnDelivery Gross Total", Name="grossTotal", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual System.Decimal grossTotal { get { return _grossTotal; } set { SetProperty(PropertygrossTotal, ref _grossTotal, value); } }

		[SMEDecimalProperty(Label="SalesReturnDelivery Cost Total", Nillable=true, Name="costTotal", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEDecimalProperty(Label="SalesReturnDelivery Profit Total", Nillable=true, Name="profitTotal", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEResource(CanGet=true, PluralName="receipts", Label="SalesReturnDelivery Receipt")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Association, IsCollection=true, Label="SalesReturnDelivery Receipt", Name="receipts", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual receiptFeed receipts { get { return _receipts; } set { SetProperty(Propertyreceipts, ref _receipts, value); } }

		[SMEResource(CanGet=true, CanPost=true, CanPut=true, CanDelete=true, PluralName="tradingAccounts")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Reference, Label="SalesReturnDelivery Invoice TradingAccount", Name="invoiceTradingAccount", Namespace="http://schemas.sage.com/crmErp/2008")]
		...
		[SMEStringProperty(Label="SalesReturnDelivery Invoice Country", Nillable=true, Name="invoiceCountry", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Delivery Country", Nillable=true, Name="deliveryCountry", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Origin Country", Nillable=true, Name="originCountry", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Type Of Business", Nillable=true, Name="typeOfBusiness", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery Statistical Process", Nillable=true, Name="statisticalProcess", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		...
		[SMEStringProperty(Label="SalesReturnDelivery User", Nillable=true, Name="user", Namespace="http://schemas.sage.com/crmErp/2008", DataType="string")]			
		public virtual System.String user { get { return _user; } set { SetProperty(Propertyuser, ref _user, value); } }

		[SMEResource(CanGet=true, PluralName="cases", Label="SalesReturnDelivery Case reference")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Association, IsCollection=true, Label="SalesReturnDelivery Case reference", Name="cases", Namespace="http://schemas.sage.com/crmErp/2008")]			
		public virtual caseFeed cases { get { return _cases; } set { SetProperty(Propertycases, ref _cases, value); } }

		[SMEResource(CanGet=true, PluralName="financialAccounts", Label="SalesReturnDelivery FinancialAccount")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Association, IsCollection=true, Label="SalesReturnDelivery FinancialAccount", Name="financialAccounts", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMEResource(CanGet=true, PluralName="interactions", Label="SalesReturnDelivery Interaction")]
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Association, IsCollection=true, Label="SalesReturnDelivery Interaction", Name="interactions", Namespace="http://schemas.sage.com/crmErp/2008")]			
		...
		[SMERelationshipProperty(Relationship=Sage.Common.Metadata.Model.RelationshipType.Child, IsCollection=true, Label="SalesReturnDelivery Note", Name="notes", Namespace="http://schemas.sage.com/crmErp/2008")]			
